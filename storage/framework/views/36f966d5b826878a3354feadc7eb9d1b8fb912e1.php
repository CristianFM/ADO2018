...
<body>
		...
		<div class="row">
			<nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2 bg-faded sidebar-style-1">
				...
				<ul class="nav nav-pills flex-column sidebar-nav">
					...
					<li class="nav-item"><a class="nav-link" href="<?php echo e(('crearAdo')); ?>"><em class="fa fa-calendar-o"></em> Crear ADO</a></li>
    ...
    <script src="<?php echo e(asset('https://npmcdn.com/tether@1.2.4/dist/js/tether.min.js')); ?>" defer></script>
